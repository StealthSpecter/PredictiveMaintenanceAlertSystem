...
#define PanSource	"alert_model.pml"
...
#define _nstates4	11	/* false_alerts */
#define minseq4	58
#define maxseq4	67
#define _endstate4	10

#define _nstates3	14	/* missed_critical_alerts */
#define minseq3	45
#define maxseq3	57
...
#define _nstates1	17	/* prediction_simulator */
#define minseq1	25
#define maxseq1	40
#define _endstate1	16

#define _nstates0	26	/* alert_generator */
#define minseq0	0
#define maxseq0	24
...
typedef struct P4 { /* false_alerts */
...
typedef struct P3 { /* missed_critical_alerts */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pprediction_simulator	((P1 *)_this)
typedef struct P1 { /* prediction_simulator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Palert_generator	((P0 *)_this)
typedef struct P0 { /* alert_generator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define HAS_TRACK	0
/* hidden variable: */	uchar alert_severity[3];
/* hidden variable: */	uchar alert_count;
